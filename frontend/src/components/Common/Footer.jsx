...
const Footer = () => {
  return (
      ...
      <footer className='border-t py-12'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4  justify-items-center'>
          <div>
            ...
            {/* newsletter form */}
            <form className='flex'>
              <input type="email" placeholder='Enter you email' className='p-3 w-full text-sm border-t border-l border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' required />
        ...
        <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
          ...
          © 2025 , PRAYOG POKHREL , All Rights Reserved
          </p>
        </div>
